                ...
                @if($data!=0)
                    ...
                    <div class="body">
                        ...
                        <div class="nonsp">
                            ...
                            <br>
                            <p>Quý khách chưa đăng bán sách</p>
                        </div>
                        @endif
...
// thong ke theo loai
                                ...
                                $.ajax({
                                        url: '{{ route('quantity_category_cus') }}',
                                        type: "GET",
                                        data: {
                                            tuNgay: $('#tuNgay').val(),
                                            denNgay: $('#denNgay').val(),
                                        ...
                                        success: function(response) {
                                            ...
                                            $objChart = new Chart($chartOfobjChart, {
                                                ...
                                                options: {
                                                    ...
                                                    title: {
                                                        display: true,
                                                        text: "Thống kê số lượng theo thể loại sách"
                                                    },
                                                    scales: {
                                                        xAxes: [{
                                                            scaleLabel: {
                            ...
                            // }
                                ...
                                $("#btnLapBaoCao2").click(function(e) {
                                    ...
                                    $.ajax({
                                        // async: false,
                                        url: '{{ route('quantity_company_cus') }}',
                                        type: "GET",
                                        data: {
                                            tuNgay: $('#tuNgay').val(),
                                            denNgay: $('#denNgay').val(),
