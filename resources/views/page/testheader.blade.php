                                ...
                                <div class="language-selector header-top__nav--item">
                                    <div class="dropdown header-top__dropdown">
                                        <a class="dropdown-toggle" id="languageID" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <span>Language: </span>
                                            <img src="{{asset('public/page/img/1.jpg')}}" alt="English"> ENGLISH
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="languageID">
                                            <a class="dropdown-item" href="#"><img src="{{asset('public/page/img/1.jpg')}}" alt="English"> English</a>
                                            <a class="dropdown-item" href="#"><img src="{{asset('public/page/img/2.jpg')}}" alt="Français"> Français</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="mini-cart__item">
                                                <div class="mini-cart__item--single">
                                                    <div class="mini-cart__item--image">
                                                        <img src="{{asset('public/page/img/electronics-4-150x167.jpg')}}" alt="product">
                                                    </div>
                                                ...
                                                <div class="mini-cart__item--single">
                                                    <div class="mini-cart__item--image">
                                                        <img src="{{asset('public/page/img/furniture-6-150x167.jpg')}}" alt="product">
                                                    </div>
                                                    <div class="mini-cart__item--content">
