        ...
        <div id="main-content">
            <div class="container-fluid">
                ...
                <div class="row clearfix">
                    <div class="col-lg-3 col-md-6">
                        <div class="card">
                            <div class="body top_counter d1">
                                <div class="icon bg-success text-white">   <i class="fa fa-money" aria-hidden="true"></i> </div>
                                <div>Tổng doanh thu tháng này</div>
                                <div style="font-size: 30px;" class="py-4 m-0 text-center h1 text-success">
                                    {{ number_format($tongt1,0,',','.') }}
                                    <span style="text-decoration: underline;"> đ</span>
                                </div>
                                <div class="d-flex">
                                    <small class="text-muted">Tháng trước</small>
                        ...
                        {{-- <div class="card">
                            <div class="body top_counter">
                                <div class="icon bg-success text-white"><i class="icon-book-open"></i> </div>
                                <div class="content">
                                    <span>Số lượng sách được bán ra</span>
                                    <div class="py-4 m-0 text-center h1 text-success">{{$book1}} cuốn
                                        </div>
                                </div>
                            </div>
                        </div> --}}
                        <div class="card">
                            <div class="body top_counter d1">
                                <div class="icon bg-success text-white">   <i class="fa fa-money" aria-hidden="true"></i> </div>
                                <div>Số lượng sách được bán ra</div>
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="body top_counter c2">
                                        <div class="icon bg-info text-white">   <i class="fa fa-money" aria-hidden="true"></i> </div>
                                        <div>Tổng doanh thu tháng trước</div>
                                        <div style="font-size: 30px;"  class="py-4 m-0 text-center h1 text-info">
                                            {{ number_format($tongt2,0,',','.') }}
                                            <span style="text-decoration: underline;"> đ</span>
                                        </div>
                                ...
                                <div class="card">
                                    {{-- <div class="body" > --}}
                                            <div class="body top_counter c2">
                                                <div class="icon bg-info text-white"><i class="fa fa-sticky-note-o" aria-hidden="true"></i> </div>
                                                <div class="text-muted">Tổng đơn hàng bán ra</div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card">
                                    <div class="body top_counter c3">
                                        <div class="icon bg-warning text-white"><i class="fa fa-money" aria-hidden="true"></i> </div>
                                        <div>Tổng doanh thu</div>
                                    <div style="font-size: 30px;"  class="py-4 m-0 text-center h1 text-warning">{{number_format($tongt, 0,',','.')}}
                                        <span style="text-decoration: underline;"> đ</span>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="body top_counter c3">
                                        <div class="icon bg-warning text-white"><i class="icon-user"></i> </div>
                                        <div class="content">
                                            <span>Lượt người xem sách</span>
                                            <div class="py-4 m-0 text-center h1 text-warning">
                                            {{$luotxem}}
                                            <span style=""> lượt</span>
                                        </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="card">
                                    ...
                                    <i class="fa fa-map-marker" style="color: #70a1ff" aria-hidden="true"></i>
                                        ...
                                        <br>
                                        <p class="mb-0 c1" style="color: #70a1ff">{{Auth::user()->delivery->delivery_address}}</p>
                                        <small class="text-muted">Xã, phường: </small>
                                        <p style="color: #70a1ff" class="mb-0 c1">{{Auth::user()->delivery->ward->ward_name}}</p>
                                        <br>
                                        <small class="text-muted c2">Quận, huyện: </small>
                                        <p style="color: #70a1ff" class="mb-0 c1">{{Auth::user()->delivery->district->district_name}}</p>
                                        <br>
                                        <small class="text-muted c2">Tỉnh, thành phố: </small>
                                        <p style="color: #70a1ff" class="mb-0 c1">{{Auth::user()->delivery->province->province_name}}</p>

                                        @else
                                        <i class="fa fa-map-marker" style="color: #70a1ff" aria-hidden="true"></i>
                                        <small class="text-muted">Địa chỉ chưa cập nhật</small>
                                    <a href="{{route('act.home')}}">
